...
extern "C" JNIEXPORT void JNICALL
Java_com_firstt175_deepdrop_session_NativeBridge_setPostProcessing(
        JNIEnv *, jobject, jint upscale, jint sharpen, jint colorPreset,
        jfloat saturation, jfloat contrast, jfloat brightness, jfloat gamma,
        jfloat temperature, jfloat exposure, jfloat highlights, jfloat shadows,
        jfloat vibrance, jint imageQuality, jint toneMapping) {
    lsfg_android::setPostProcessing(
        static_cast<int>(upscale), static_cast<int>(sharpen), static_cast<int>(colorPreset),
        static_cast<float>(saturation), static_cast<float>(contrast), static_cast<float>(brightness),
        static_cast<float>(gamma), static_cast<float>(temperature), static_cast<float>(exposure),
        static_cast<float>(highlights), static_cast<float>(shadows), static_cast<float>(vibrance),
        static_cast<int>(imageQuality), static_cast<int>(toneMapping));
}
