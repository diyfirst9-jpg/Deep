...
// Hot-apply the presentation post-processing chain. Enum values are stable:
// upscale 0..5 (Off/Bilinear/Bicubic/Lanczos/FSR1/NIS), sharpen 0..3,
// colorPreset 0..6, imageQuality 0..4, toneMapping 0..4.
