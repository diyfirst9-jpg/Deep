...
object NativeBridge {
    ...
    /** Hot-applies the presentation post-processing chain without recreating frame-gen.
     * All processing is optional; 0 means Off for each enum.
     */
    external fun setPostProcessing(
        upscale: Int, sharpen: Int, colorPreset: Int,
        saturation: Float, contrast: Float, brightness: Float, gamma: Float,
        temperature: Float, exposure: Float, highlights: Float, shadows: Float, vibrance: Float,
        imageQuality: Int, toneMapping: Int,
    )
